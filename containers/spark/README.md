...
A spark container with Scala, Python. Versions matched to support Azure SDKs.

| Metadata | Value |  
|----------|-------|
| *Contributors* | Ian Philpot, @ianphil |
| *Definition type* | Dockerfile |
| *Works in Codespaces* | Yes |
| *Container host OS support* | Linux, macOS, Windows |
| *Languages, platforms* | Java, Scala, Python, Spark, Hadoop |
